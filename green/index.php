		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	...
			   	<li style="background-image: url(images/01_03.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
			   	...
			   	<li style="background-image: url(images/01_05.jpg);">
			   		<div class="overlay"></div>
			   	...
			   	<li style="background-image: url(images/01_02.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 search-wrap">
						<form action="reservation.php" method="get" name="reservation" class="colorlib-form" autocomplete="off">
		              	<div class="row">
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
													...
													<input type="text" id="testDatepicker" name="date_from" class="form-control date" placeholder="Check-in date" readonly>
		                      <!-- <input type="text" id="date" name="book_date1" class="form-control date" placeholder="Check-in date"> -->
		                    </div>
		                  </div>
		                </div>
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
		                      <!-- <i class="icon icon-calendar2"></i> -->
													<input type="text" id="testDatepicker2" name="date_to" class="form-control date" placeholder="Check-out date" readonly>
													<!-- <input type="text" id="date" name="book_date2" class="form-control date" placeholder="Check-out date"> -->
		                    </div>
		                  </div>
		                </div>
		                <div class="col-md-2">
		                ...
		                <div class="col-md-2">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
		                      <i class="icon icon-arrow-down3"></i>
		                      <select id="people" name="room_id" class="form-control">
														<option value="r1">1학년</option>
		                        <option value="r2">2학년</option>
		                        <option value="r3">3학년</option>
		                        <option value="r4">4학년</option>
														<option value="r5">5학년</option>
														<option value="r6">6학년</option>
														<option value="r7">숙직실</option>
														<option value="r8">교장실</option>
														<option value="r9">교무실</option>
...
?>
		<div id="colorlib-rooms" class="colorlib-light-grey font-family">
			<div class="container">
				<div class="row">
...
<?	
		...
		$room_img_main,$room_img_sub1,$room_img_sub2,$room_img_thumb,$room_img_sub3)=mysqli_fetch_array($rs)){			
?>

							<div class="item">
								<a href="roomDetail.php?room_id=<?=$room_id?>" title="<?=$room_name?>"><img src="<?=$room_img_thumb?>" width="300" height="300"></a>
								<div class="desc text-center">
									<h3 style="font-family: Arial; color:#410000; font-size:22px; font-weight:bold"><a href="rooms-suites.html"><?=$room_name?></a></h3>
									<p class="price">
									...
									<p><a href="reservation.php?room_id=<?=$room_id?>" class="btn btn-primary btn-book">예약하기</a></p>
								</div>
							</div>
...
<?}?>	
					...
					<div class="col-md-12 text-center animate-box">
						<a href="rooms.php" style="font-size:2.0em">View all rooms <i class="icon-arrow-right3"></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="diningbar-flex">
								...
								<div role="tabpanel" class="tab-pane active" id="mains">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="images/campfire1.jpg" alt="campfire"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="images/barbecue.jpg" alt="barbecue"></figure>
							                <div class="text">
			         ...
			         <div class="half diningbar-img" style="background-image: url(images/campfire1.jpg);"></div><!-- end half -->
			      </div>
			   </div>
	      </div>
		</div>
		...
		<div id="colorlib-blog">
			<div class="container">
				...
				<div class="blog-flex">
					<div class="video colorlib-video" style="background-image: url(images/tour.jpg);">
						<!-- <a href="tour.php" class="popup-vimeo"></a> -->
						<div class="overlay"></div>
					</div>
					<div class="blog-entry">
						<div class="row">
							<div class="col-md-12 animate-box">
								<a href="tour.php" class="blog-post">
									<span class="img" style="background-image: url(images/tourimags-5.jpg);"></span>
									<div class="desc">
										<!-- <span class="date">January 14, 2018</span> -->
										<h3>석탄 박물관</h3>
										<span class="cat">View More</span>
									</div>
								</a>
							</div>
							<div class="col-md-12 animate-box">
								<a href="tour.php" class="blog-post">
									<span class="img" style="background-image: url(images/tourimags-7.jpg);"></span>
									<div class="desc">
										<!-- <span class="date">January 14, 2018</span> -->
										<h3>속리산 문장대</h3>
										<span class="cat">View More</span>
							...
							<div class="col-md-12 animate-box">
								<a href="tour.php" class="blog-post">
									<span class="img" style="background-image: url(images/tourimags-4.jpg);"></span>
									<div class="desc">
										<!-- <span class="date">January 14, 2018</span> -->
										<h3>쌍용계곡</h3>
										<span class="cat">View More</span>
							...
							<div class="col-md-12 animate-box text-right">
								<a href="tour.php" style="font-size:2.0em">View all Tour<i class="icon-arrow-right3"></i></a>
							</div>
						</div>
					</div>
				</div>
