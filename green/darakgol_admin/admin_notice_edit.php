...
<form action='admin_notice_update.php?notice_id=<?=$notice_id?>' method='post' class="w3-container">
  <p>
  <label>글제목</label>
  <input class="w3-input w3-border" name='notice_title' type="text" value='<?=$notice_title?>'></p>
  <p>
  <label>내용</label>
  <textarea class="w3-input w3-border" name='notice_content' type="text"  rows='30'><?=$notice_content?></textarea></p>
  <p><center>
