	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(playground-3339146_1280.jpg);">
        ...
        <div id="wrap">
            <div id="rTopmenu">
                <ul id="rList">
                    ...
                    <li>
                        <a href="#" class="selected">예약확인/취소</a>
                    </li>
                </ul>
            </div>

            <div id="select_list">
                <div id="stitle">고객님의 예약정보는 아래와 같습니다.</div>
                <div id="slist">
                    <table class="alist" border="1">
                        <tr>
                            <td colspan=2>예약자</td>
                            <td colspan=4><?= $book_name?></td>
                        </tr>
                        <tr>
                            <td colspan=2>요청사항</td>
                            <td colspan=4><?= $book_comment?></td>
                        </tr>
                        <tr>
                            <td colspan=2>객실명</td>
                            <td colspan=2>이용기간</td>
                            <td>인원수</td>
                            <td>객실요금</td>
                        </tr>
                        <tr>
                            <td colspan=2><?= $room_name ?></td>
                            <td colspan=2><?= $book_date?></td>
                            <td><?=$book_person?></td>
                            <td><?= $room_price?></td>
                        </tr>
                        <tr>
                            <td colspan=6>기타이용옵션</td>
                        </tr>
                        <tr>
                            <td colspan=6>
                                <script>
