...
<?php 
	while(list($goodsId,$goodsNm,$goodsPrice,$goodsDesc1,$goodsDesc2,$goodsDesc3,$goodsDesc4,$goodsImg1,$goodsImg2,$goodsImg3,$goodsImg4,$goodsImg5)=mysqli_fetch_row($rs)){
?>
